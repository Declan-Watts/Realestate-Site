...
$id = $_GET["id"];
$query = "SELECT * FROM Houses WHERE House_ID ='$id' "; // selects all from 'houses' where House_ID = id
...
$query = "SELECT * FROM Agent_Houses WHERE House_ID ='$id' "; // selects all from 'Agent_Houses' where House_ID = id
$result = mysqli_query($db, $query); // returns result
